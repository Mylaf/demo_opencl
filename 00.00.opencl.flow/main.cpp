...
int main(int argc, char* argv[])
{
    ...
    const char *filename = "C:/Users/SHAO/Desktop/opencl_demo/00_01/kernel_helloworld.cl";
    string sourceStr;
    ...
    cl_event eventPoint;
    status = clEnqueueNDRangeKernel(commandQueue, kernel, 1, NULL, global_work_size, NULL, 0, NULL, &eventPoint);
